        ...
        <div id="content-wrap" className="styles">
            ...
            <div className="row">
                ...
                <div className="col-six tab-full">
                    ...
                    <p><a href="#"><Image width="120" height="120" className="pull-left" alt="sample-image" src="/images/sample-image.jpg"/></a>
            ...
            <div className="row half-bottom">
                ...
                <div className="col-six tab-full relative">

                    <h3>Responsive Image</h3>
                    <p><Image src="/images/shutterbug.jpg" alt={''} width={400} height={400}  className={"w-full h-full"} /></p>
                ...
                <div className="col-six tab-full">
                    ...
                    <div className="fluid-video-wrapper">
                        <iframe src="http://player.vimeo.com/video/14592941?title=0&amp;byline=0&amp;portrait=0&amp;color=F64B39" width="500" height="281" frameBorder="0" allowFullScreen></iframe>
                    </div>
                ...
                <div className="col-six tab-full">
                    ...
                    <form>
                        ...
                        <label className="add-bottom">
                            <input type="checkbox" className="label-text" />
