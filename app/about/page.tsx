        ...
        <div className="col-twelve">
            ...
            <section>  
                ...
                <div className="content-media">						
                     <Image src="/images/thumbs/about-us.jpg" alt={''} width={400} height={400} className='w-full'/>						  
                 </div>
                 ...
                 <div className="primary-content">
                     ...
                     <p className="lead">Lorem ipsum Nisi cillum reprehenderit minim sunt dolore dolor eiusmod eu aliquip ad ut sint dolore laborum voluptate ullamco dolore aliquip enim. Excepteur cillum cupidatat fugiat nostrud cupidatat dolor sunt sint sit nisi est eu exercitation incididunt adipisicing</p> 
