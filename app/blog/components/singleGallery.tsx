...
const SingleGallery = (props: Props) => {
    return (
                ...
                <div className="col-twelve">
                    ...
                    <article className="format-gallery">
                        ...
                        <div className="primary-content">
                            ...
                            <p><Image src="/images/shutterbug.jpg" alt="" width={600} height={600} /></p>
...
border-radius: 3px;
                            ...
                            <div className="author-profile">
                                <Image src="/images/avatars/user-05.jpg" alt="" width={600} height={600} />
